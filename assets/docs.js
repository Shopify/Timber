  ...
  if (docsNav.length) {
    ...
    $('.gettingstarted-title').each(function() {
      var el = $(this),
          title = el.html(),
          hash = el.attr('id');
      gettingstartedNav.append('<li><a href="#'+ hash +'">'+ title +'</a></li>');
    });
    ...
    $('.styleguide-title').each(function() {
      var el = $(this),
          title = el.html(),
          hash = el.attr('id');
      styleguideNav.append('<li><a href="#'+ hash +'">'+ title +'</a></li>');
    });
    ...
    $('.module-title').each(function() {
    	var el = $(this),
    			title = el.html(),
    			hash = el.attr('id');
    	moduleNav.append('<li><a href="#'+ hash +'">'+ title +'</a></li>');
    });
    ...
    $('.js-title').each(function() {
      var el = $(this),
          title = el.html(),
          hash = el.attr('id');
      jsModuleNav.append('<li><a href="#'+ hash +'">'+ title +'</a></li>');
    });


    // Auto stick the nav
    docsNav.scrollToFixed();
  }
